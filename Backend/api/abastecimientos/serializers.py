...
class AbastecimientoSerializer(serializers.ModelSerializer):
    ...
    def validate_fecha(self, value):
        ...
        La fecha debe estar entre hoy y máximo 7 días atrás (igual que en Compras).
        """
        ...
        if value < hace7Dias:
            raise serializers.ValidationError("La fecha debe estar entre hoy y máximo 7 días atrás")
