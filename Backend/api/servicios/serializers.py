...
class ServicioSerializer(serializers.ModelSerializer):
    ...
    puede_eliminar = serializers.SerializerMethodField()  # Campo calculado para validaciones
    restricciones_eliminacion = serializers.SerializerMethodField()  # Información detallada de restricciones
    ...
    def get_puede_eliminar(self, obj):
        """Obtener si el servicio puede ser eliminado"""
        return obj.puede_eliminar()

    def get_restricciones_eliminacion(self, obj):
        """Obtener información detallada de restricciones"""
        return obj.get_restricciones_eliminacion()
