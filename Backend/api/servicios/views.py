...
class ServicioViewSet(viewsets.ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        restricciones = instance.get_restricciones_eliminacion()
        ...
        # Si puede ser eliminado, proceder con la eliminación
    ...
    def verificar_eliminacion(self, request, pk=None):
        ...
        restricciones = servicio.get_restricciones_eliminacion()
    ...
    def cambiar_estado(self, request, pk=None):
        ...
        PERMITIDO: Se puede cambiar estado libremente sin validaciones de asociaciones.
        """
        servicio = self.get_object()
        nuevo_estado = 'inactivo' if servicio.estado == 'activo' else 'activo'
        
        # Cambiar estado sin validaciones de asociaciones
    ...
    @action(detail=False, methods=['get'])
    def restricciones_eliminacion(self, request):
        """
        Obtener información de restricciones de eliminación para todos los servicios.
        """
        ...
        for servicio in servicios:
            ...
            restricciones_data.append({
                ...
                'puede_eliminar': restricciones['puede_eliminar'],
                'citas_count': restricciones['citas_count'],
                'ventas_count': restricciones['ventas_count'],
                'mensaje': restricciones['mensaje']
            })
        
        return Response({
            'total_servicios': len(restricciones_data),
            'servicios_con_restricciones': len([s for s in restricciones_data if not s['puede_eliminar']]),
            'servicios_sin_restricciones': len([s for s in restricciones_data if s['puede_eliminar']]),
